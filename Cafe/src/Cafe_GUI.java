...
public class Cafe_GUI {
	...
	private void initialize() {	
		...
		Qsize.setFont(new Font("한컴 백제 M", Font.PLAIN, 21));
		...
		qHorI.setFont(new Font("한컴 백제 M", Font.PLAIN, 21));
		...
		topping.setFont(new Font("한컴 백제 M", Font.PLAIN, 30));	//문구 폰트,크기
		...
		add2.setFont(new Font("한컴 백제 M", Font.PLAIN, 30));
		...
		add1.setFont(new Font("한컴 백제 M", Font.PLAIN, 30));
		...
		payment.setFont(new Font("한컴 백제 M", Font.PLAIN, 30));
				...
				price = 3000;
					...
					y.addActionListener(new ActionListener() {//토핑추가에 yes버튼을 누르면
						...
						public void actionPerformed(ActionEvent e) {
							...
							allprice.setText("총 지불 금액 : " + (price+ tprice)+ "원");
					...
					n.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							allprice.setText("총 지불 금액 : " +price+ "원");
							allprice.setBounds(140,90,350,50);
							allprice.setFont(f1);
							Result.add(allprice);
